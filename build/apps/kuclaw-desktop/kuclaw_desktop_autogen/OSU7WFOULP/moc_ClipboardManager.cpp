...
#include "../../../../../src/core/clipboard/ClipboardManager.h"
...
template <> constexpr inline auto ClipboardManager::qt_create_metaobjectdata<qt_meta_tag_ZN16ClipboardManagerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(const ClipboardPayload &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
    };
...
void ClipboardManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->clipboardChanged((*reinterpret_cast<std::add_pointer_t<ClipboardPayload>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ClipboardManager::*)(const ClipboardPayload & )>(_a, &ClipboardManager::clipboardChanged, 0))
            return;
    }
}
...
// SIGNAL 0
void ClipboardManager::clipboardChanged(const ClipboardPayload & _t1)
{
