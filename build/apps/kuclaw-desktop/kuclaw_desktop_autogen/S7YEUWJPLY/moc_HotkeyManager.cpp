...
#include "../../../../../src/core/hotkey/HotkeyManager.h"
...
void HotkeyManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->registrationFailed((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (HotkeyManager::*)(const QString & )>(_a, &HotkeyManager::hotkeyTriggered, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (HotkeyManager::*)(const QString & , const QString & )>(_a, &HotkeyManager::registrationFailed, 1))
            return;
    }
}
...
// SIGNAL 1
void HotkeyManager::registrationFailed(const QString & _t1, const QString & _t2)
{
